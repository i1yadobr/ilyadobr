...
<tr class='title'>
<th style='width:125px;text-align:right;'>CKEY <a href='?src=\ref[src];editrights=add'>\[+\]</a></th>
...
"}
	...
	for(var/adm_ckey in admin_datums)
		...
		output += "<tr>"
		output += "<td style='text-align:right;'>[adm_ckey] <a href='?src=\ref[src];editrights=remove;ckey=[adm_ckey]'>\[-\]</a></td>"
		output += "<td><a href='?src=\ref[src];editrights=rank;ckey=[adm_ckey]'>[rank]</a></td>"
		output += "<td><a href='?src=\ref[src];editrights=permissions;ckey=[adm_ckey]'>[rights]</a></td>"
		output += "</tr>"
