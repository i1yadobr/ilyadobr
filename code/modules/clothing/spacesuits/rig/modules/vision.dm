...
/obj/item/rig_module/vision/engage()
	...
	if(starting_up)
		to_chat(holder.wearer, SPAN("info", "You activate your visual sensors."))
		return 1
	...
	if(vision_modes.len > 1)
		...
		to_chat(holder.wearer, SPAN("info", "You cycle your sensors to <b>[vision.mode]</b> mode."))
	else
		to_chat(holder.wearer, SPAN("info", "Your sensors only have one mode."))
	return 1
