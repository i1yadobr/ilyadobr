...
/obj/item/rig_module/chem_dispenser/accepts_item(obj/item/input_item, mob/living/user)
	...
	if(total_transferred)
		to_chat(user, SPAN("info", "You transfer [total_transferred] units into the suit reservoir."))
	else
...
/obj/item/rig_module/chem_dispenser/engage(atom/target)
	...
	if(target_mob != H)
		to_chat(H, SPAN("danger", "You inject [target_mob] with [chems_to_use] unit\s of [charge.display_name]."))
	to_chat(target_mob, SPAN("danger", "You feel a rushing in your veins as [chems_to_use] unit\s of [charge.display_name] [chems_to_use == 1 ? "is" : "are"] injected."))
