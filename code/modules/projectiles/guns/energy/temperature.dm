...
/obj/item/gun/energy/temperature/think()
	switch(temperature)
		...
		if(201 to 300) charge_cost = 20
		if(301 to 400) charge_cost = 30
		if(401 to 500) charge_cost = 40
		if(501 to 600) charge_cost = 50
		if(601 to 700) charge_cost = 60
		if(701 to 800) charge_cost = 70
