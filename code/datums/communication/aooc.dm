...
/decl/communication_channel/aooc/do_communicate(client/C, message)
	...
	for(var/client/target in GLOB.clients)
		if(target.holder)
			receive_communication(C, target, "<span class='ooc'>[SPAN("aooc", "[create_text_tag("aooc", "Antag-OOC")] <EM>[get_options_bar(C, 0, 1, 1)]:</EM> [SPAN("message linkify", "[message]")]")]</span>")
			...
			receive_communication(C, target, "<span class='ooc'>[SPAN("aooc", "[create_text_tag("aooc", "Antag-OOC")] <EM>[player_display]:</EM> [SPAN("message linkify", "[message]")]")]</span>")
