...
/obj/item/shockpaddles/proc/do_electrocute(mob/living/carbon/human/H, mob/user, target_zone)
	...
	playsound(src, 'sound/machines/defib_charge.ogg', 50, 0)
	audible_message("<span class='warning'>\The [src] lets out a steadily rising hum...</span>", runechat_message = "*hummm*")
...
/obj/item/shockpaddles/proc/make_announcement(message, msg_class)
	audible_message("<b>\The [src]</b> [message]", "\The [src] vibrates slightly.", runechat_message = "[message]")
...
/obj/item/shockpaddles/linked/make_announcement(message, msg_class)
	base_unit.audible_message("<b>\The [base_unit]</b> [message]", "\The [base_unit] vibrates slightly.", runechat_message = "[message]")
